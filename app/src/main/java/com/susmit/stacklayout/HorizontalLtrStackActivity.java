...
class HorizontalLtrStackActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        viewGestureDetector = new ChildGestureDetector(HorizontalLtrStackActivity.this, new GestureDetector.SimpleOnGestureListener(){
            @Override
            public boolean onSingleTapUp(MotionEvent e) {
                Toast.makeText(HorizontalLtrStackActivity.this, " "+viewGestureDetector.getView().getY(), Toast.LENGTH_SHORT).show();
                return true;
            }
        ...
        ((HorizontalStackLayout)findViewById(R.id.hltr)).addView(view, 3, p);
        ...
        view.setImageDrawable(new ColorDrawable(Color.YELLOW));
        ((HorizontalStackLayout)findViewById(R.id.hltr)).addView(view, p);
